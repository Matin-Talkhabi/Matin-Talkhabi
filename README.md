[<h1 align="center">سلام، من متین ام 👋</h1>
<h3 align="center">دانشجوی مهندسی کامپیوتر و برنامه‌نویس فول‌استک با علاقه به ساخت چیزهای باحال 😄</h3>

<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&center=true&width=435&lines=Full-Stack+Developer;Python+%7C+Django+%7C+Tailwind+CSS;Always+Learning+%F0%9F%93%9A;Code%2C+Debug%2C+Repeat+%F0%9F%94%A5" alt="Typing SVG" />
</p>
...
<img src="http://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=Matin-Talkhabi&theme=2077" />
...
- 🛠️ عاشق ترکیب Front-end و Back-end با طعم Tailwind و Django  
- 💡 توی فراغت دنبال ساخت پروژه‌هایی هستم که هم خودم یاد بگیرم هم به بقیه کمک کنه  
- 🚀 تمرکز روی مهارت‌ورزی بیشتر تا تخصص عمیق در ابزارهای کاربردی  
- 🎯 هدفم تبدیل پروژه‌های ساده به نمونه‌کارهای واقعی قابل ارائه‌ست  
---

### ⚙️ مهارت‌ها

[![My Skills](https://skillicons.dev/icons?i=python,django,cpp,cs,js,html,css,tailwind,sqlite,mysql,git,github&theme=light&perline=8)]()
